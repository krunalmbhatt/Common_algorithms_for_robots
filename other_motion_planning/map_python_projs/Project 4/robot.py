...
class Robot:
    ...
    def check_collision_config(
        ...
        #                 return True
        #         if robo_edg is not robot_edges:
        #             if is_intersecting(robo_edg, robo_edg):
        #                 return True
...
class OmnidirectionalRobot(Robot):
    ...
    def get_edges(self, config):
        ...
        edges = [(corners[i], corners[(i + 1)]) for i in range(4)]
...
class KinematicChain(Robot):
    ...
    def interpolate(self, config1, config2, num=10):
        ...
        for i in range(num + 1):
            ...
            interpolated_configs.append(interp_config)
        return interpolated_configs
